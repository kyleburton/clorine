...
<pre>
   ...
   (defn record-restock-orders [item-sku store-number date]
     ...
     ;; the inventory database is establishd (pulled from the pool) and defines
     ...
     (with-connection :inventory
       (let [items-sold      (get-items-sold item-sku store-number date)
         ...
         (sql/do-prepared "INSERT INTO restock_items (sku,sotore_num,order_date) values (?,?,current_date)"
